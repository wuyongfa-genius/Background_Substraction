...
from unet_mod.models.unet import TinyUNet3d
from unet_mod.datasets.mod import MOD_3d
from unet_mod.utils import (collect_env, get_root_logger,
                            ClosedFormCosineLRScheduler, accuarcy, mIoU, average_preds, flat_gts, flat_paths)
...
def arg_parser():
    ...
    parser.add_argument("--log_dir", default='exps/unet3d')
